/********************************************************************
	created:	2012/09/20
	filename: 	AudioEngineImp.h
	author:		reedhong
	
	purpose:	win32声音引擎，接口的定义学习cocos2d-x, 使用fmod
*********************************************************************/

#ifndef __Lotus2d_Win32_AudioEngineImp_H__
#define __Lotus2d_Win32_AudioEngineImp_H__
...
namespace Lotus2d {
	...
	private:
		FSOUND_SAMPLE*		mMusic;			// 当前准备播放的音乐
	};
}
